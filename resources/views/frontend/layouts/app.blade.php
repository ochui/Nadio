...
<head>
    ...
    <title>Nadio Real Estate Agency</title>
    <meta name=description content="We provide a more reliable alternative in the property acquisition and management process.
    Rent, lease, sell or Purchase landed property in Nigeria."/>
    ...
    <body>
        ...
        {{-- SLIDER SECTION --}}
        @if(Request::is('/') || Request::is('property*') || Request::is('search*'))
